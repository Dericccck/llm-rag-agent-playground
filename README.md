...
- [02-azureaiagent.ipynb](2-3-ai-agents-for-beginners/02-explore-agentic-frameworks/02-azureaiagent.ipynb)：Azure AI Agent Service 版本的基础代理示例，偏环境依赖说明与框架对照。更适合作为云端托管式 Agent 能力了解。
...
- [03-dotnet-agent-framework.ipynb](2-3-ai-agents-for-beginners/03-agentic-design-patterns/03-dotnet-agent-framework.ipynb)：用 .NET 版本演示常见 Agent 设计模式。适合横向比较不同语言生态的表达方式。
...
- [04-semantic-kernel-python-aiagent-bookinghotel.ipynb](2-3-ai-agents-for-beginners/04-tool-use/04-semantic-kernel-python-aiagent-bookinghotel.ipynb)：基于 Azure 服务的酒店预订工具调用示例，主要用于理解工具接入流程。适合理解真实业务动作如何接入 Agent。
...
- [05-autogen-azuresearch.ipynb](2-3-ai-agents-for-beginners/05-agentic-rag/05-autogen-azuresearch.ipynb)：AutoGen + Azure AI Search 的 Agentic RAG 版本，用来对照本地 ChromaDB 方案。更偏云服务集成视角。
...
- [05-semantic-kernel-azure-ai-agent.ipynb](2-3-ai-agents-for-beginners/05-agentic-rag/05-semantic-kernel-azure-ai-agent.ipynb)：用 Azure AI Agent Service 和 Semantic Kernel 组合实现 RAG Agent。适合了解托管式 Agent 和 RAG 的结合方式。
- [05-semantic-kernel-azuresearch.ipynb](2-3-ai-agents-for-beginners/05-agentic-rag/05-semantic-kernel-azuresearch.ipynb)：Semantic Kernel + Azure AI Search 的 Agentic RAG 版本，用来对照本地向量库实现。重点是服务化检索接入。
...
- [07-azure-openai.ipynb](2-3-ai-agents-for-beginners/07-planning-design/07-azure-openai.ipynb)：基于 Azure OpenAI 的规划设计示例，重点在云服务接入方式。适合了解云端接口下的规划能力接法。
...
- [08-python_multi_aiagent_bookinghotel.ipynb](2-3-ai-agents-for-beginners/08-multi-agent/08-python_multi_aiagent_bookinghotel.ipynb)：基于 Azure 服务的多代理酒店预订示例，主要用于理解角色协作链路。更偏业务流程编排。
